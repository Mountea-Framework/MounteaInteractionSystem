...
The changelist is available publicly <a id="browser" href="https://github.com/Mountea-Framework/MounteaInteractionSystem/blob/5.2/CHANGELOG.md">on our GitHub</>.
		)");
