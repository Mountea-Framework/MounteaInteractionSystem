...
protected:
	...
	UPROPERTY(VisibleAnywhere, Category="MounteaInteraction|Debug")
...
private:
	 ...
	 * 1 means 100%
	 */
	UPROPERTY(VisibleAnywhere, Category="MounteaInteraction|Debug", meta=(ClampMax=1, UIMax=1, ClampMin=0, UIMin=0))
