...
#include "MounteaInteractionSettingsConfigAssetFactory.generated.h"

/**
 * 
 */
UCLASS()
class MOUNTEAINTERACTIONSYSTEMEDITOR_API UInteractionSettingsConfigAssetFactory : public UFactory
{
	GENERATED_BODY()
