...
#include "MounteaInteractionEditorUtilities.h"

#include "K2Node_Event.h"
#include "Factories/MounteaInteractionClassViewerFilter.h"
#include "Kismet2/BlueprintEditorUtils.h"
#include "Kismet2/KismetEditorUtilities.h"
#include "Kismet2/SClassPickerDialog.h"

bool FMounteaInteractionEditorUtilities::PickChildrenOfClass(const FText& TitleText, UClass*& OutChosenClass, UClass* Class)
{
	// Create filter
	const TSharedPtr<FMounteaInteractionClassViewerFilter> Filter = MakeShareable(new FMounteaInteractionClassViewerFilter);
...
UK2Node_Event* FMounteaInteractionEditorUtilities::BlueprintGetOrAddEvent(UBlueprint* Blueprint, FName EventName,
...
UK2Node_Event* FMounteaInteractionEditorUtilities::BlueprintGetEvent(UBlueprint* Blueprint, FName EventName,
	UClass* EventClassSignature)
{
	if (!Blueprint || Blueprint->BlueprintType != BPTYPE_Normal)
	{
...
UEdGraph* FMounteaInteractionEditorUtilities::BlueprintGetOrAddFunction(UBlueprint* Blueprint, FName FunctionName,
...
UEdGraph* FMounteaInteractionEditorUtilities::BlueprintGetFunction(UBlueprint* Blueprint, FName FunctionName,
	UClass* FunctionClassSignature)
{
	if (!Blueprint || Blueprint->BlueprintType != BPTYPE_Normal)
	{
