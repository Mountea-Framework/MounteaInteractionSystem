...
#include "MounteaInteractorInterface.generated.h"
...
class UMounteaInteractorInterface : public UInterface
{
	GENERATED_BODY()
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInteractableSelected,			const TScriptInterface<IMounteaInteractableInterface>&, SelectedInteractable);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInteractableFound,				const TScriptInterface<IMounteaInteractableInterface>&, FoundInteractable);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInteractableLost,					const TScriptInterface<IMounteaInteractableInterface>&, LostInteractable);
 ...
 * 
 */
class MOUNTEAINTERACTIONSYSTEM_API IMounteaInteractorInterface
{
	GENERATED_BODY()
...
public:
	...
	void OnInteractableSelectedEvent(const TScriptInterface<IMounteaInteractableInterface>& SelectedInteractable);
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void OnInteractableFoundEvent(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable);
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void OnInteractableLostEvent(const TScriptInterface<IMounteaInteractableInterface>& LostInteractable);
...
#pragma endregion
	 ...
	 * For details of Evaluation visit GitHub Wiki: https://github.com/Mountea-Framework/ActorInteractionSystem/wiki/Interactor-Evaluation
	 * 
	 * @param FoundInteractable Interactable which was found
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void EvaluateInteractable(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable);
	virtual void EvaluateInteractable_Implementation(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void InteractableFound(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable);
	virtual void InteractableFound_Implementation(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void InteractableLost(const TScriptInterface<IMounteaInteractableInterface>& LostInteractable);
	virtual void InteractableLost_Implementation(const TScriptInterface<IMounteaInteractableInterface>& LostInteractable) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void InteractableSelected(const TScriptInterface<IMounteaInteractableInterface>& SelectedInteractable);
	virtual void InteractableSelected_Implementation(const TScriptInterface<IMounteaInteractableInterface>& SelectedInteractable) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void AddInteractionDependency(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency);
	virtual void AddInteractionDependency_Implementation(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void RemoveInteractionDependency(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency);
	virtual void RemoveInteractionDependency_Implementation(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency) = 0;
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	TArray<TScriptInterface<IMounteaInteractorInterface>> GetInteractionDependencies() const;
	virtual TArray<TScriptInterface<IMounteaInteractorInterface>> GetInteractionDependencies_Implementation() const = 0;

	/**
	 * Tries to process all dependencies according to current State.
	 * For more information, visit GitHub Wiki: https://github.com/Mountea-Framework/ActorInteractionSystem/wiki/Process-Interactor-Dependencies
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	 ...
	 * State machine apply!
	 * For more information, visit GitHub Wiki: https://github.com/Mountea-Framework/ActorInteractionSystem/wiki/Actor-Interactor-Component-Validations#state-machine
	 * 
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	void SetActiveInteractable(const TScriptInterface<IMounteaInteractableInterface>& NewInteractable);
	virtual void SetActiveInteractable_Implementation(const TScriptInterface<IMounteaInteractableInterface>& NewInteractable) = 0;

	/**
	 * Returns Active Interactable if there is any. Otherwise null.
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category="Mountea|Interaction|Interactor")
	TScriptInterface<IMounteaInteractableInterface> GetActiveInteractable() const;
	virtual TScriptInterface<IMounteaInteractableInterface> GetActiveInteractable_Implementation() const = 0;
