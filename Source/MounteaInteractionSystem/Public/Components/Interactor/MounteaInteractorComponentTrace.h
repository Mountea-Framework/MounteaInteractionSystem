...
#include "MounteaInteractorComponentTrace.generated.h"
...
class MOUNTEAINTERACTIONSYSTEM_API UMounteaInteractorComponentTrace : public UMounteaInteractorComponentBase
{
	GENERATED_BODY()
