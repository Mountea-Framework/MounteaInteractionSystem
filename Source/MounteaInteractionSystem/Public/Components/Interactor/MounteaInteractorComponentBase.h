...
#include "MounteaInteractorComponentBase.generated.h"
 ...
 *
 * Implements MounteaInteractorInterface.
 * Networking is not implemented.
 *
 * @see https://github.com/Mountea-Framework/ActorInteractionSystem/wiki/Actor-Interactor-Component-Base
 */
...
class MOUNTEAINTERACTIONSYSTEM_API UMounteaInteractorComponentBase : public UActorComponent, public IMounteaInteractorInterface
{
	GENERATED_BODY()

public:

	UMounteaInteractorComponentBase();
...
#pragma region NativeFunctions
	...
	virtual void InteractableSelected_Implementation(const TScriptInterface<IMounteaInteractableInterface>& SelectedInteractable) override;
	
	virtual void InteractableFound_Implementation(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable) override;
	
	virtual void InteractableLost_Implementation(const TScriptInterface<IMounteaInteractableInterface>& LostInteractable) override;
...
public:
	...
	virtual void EvaluateInteractable_Implementation(const TScriptInterface<IMounteaInteractableInterface>& FoundInteractable) override;
	...
	virtual void AddInteractionDependency_Implementation(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency) override;
	virtual void RemoveInteractionDependency_Implementation(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency) override;
	virtual TArray<TScriptInterface<IMounteaInteractorInterface>> GetInteractionDependencies_Implementation() const override;
	...
	virtual void SetActiveInteractable_Implementation(const TScriptInterface<IMounteaInteractableInterface>& NewInteractable) override;
	virtual TScriptInterface<IMounteaInteractableInterface> GetActiveInteractable_Implementation() const override;
...
protected:
	...
	UFUNCTION(Server, Unreliable)
	void AddInteractionDependency_Server(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency);
	UFUNCTION(Server, Unreliable)
	void RemoveInteractionDependency_Server(const TScriptInterface<IMounteaInteractorInterface>& InteractionDependency);
	...
	UFUNCTION(Server, Reliable)
	void SetActiveInteractable_Server(const TScriptInterface<IMounteaInteractableInterface>& NewInteractable);
	...
	void SetActiveInteractable_Client(const TScriptInterface<IMounteaInteractableInterface>& NewInteractable);
...
private:
	...
	TScriptInterface<IMounteaInteractableInterface> ActiveInteractable;
	
	// List of interactors suppressed by this one
	UPROPERTY(Replicated, VisibleAnywhere, Category="MounteaInteraction|Read Only")
	TArray<TScriptInterface<IMounteaInteractorInterface>> InteractionDependencies;
...
protected:
	...
	DECLARE_EVENT(UMounteaInteractorComponentBase, FRequestInteractorEditorDefaults);
